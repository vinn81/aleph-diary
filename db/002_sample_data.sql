...
VALUES
  ('2026-08-24', '이번 주의 우선순위를 정리하고 가장 중요한 일부터 시작하기'),
  ('2026-08-25', '오전에 집중 시간을 확보해 미뤄둔 작업의 첫 단계를 끝내기'),
  ('2026-08-26', '회의와 작업 사이의 전환 시간을 줄이고 흐름을 지키기'),
  ('2026-08-27', '작게라도 운동하고 저녁에는 일에서 벗어나는 시간 만들기'),
  ('2026-08-28', '한 주의 기록을 돌아보고 다음 주에 유지할 습관 정하기')
...
JOIN diary_days AS day ON day.diary_date = sample.diary_date
